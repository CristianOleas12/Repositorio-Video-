 ...
 * 
 */
@WebServiceClient(name = "Servicios", targetNamespace = "http://webservicecli/", wsdlLocation = "http://localhost:8080/ServidorBaseCliente/Servicios?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOS_QNAME = new QName("http://webservicecli/", "Servicios");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ServidorBaseCliente/Servicios?wsdl");
    ...
    public Servicios getServiciosPort() {
        return super.getPort(new QName("http://webservicecli/", "ServiciosPort"), Servicios.class);
    }
    ...
    public Servicios getServiciosPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservicecli/", "ServiciosPort"), Servicios.class, features);
    }
